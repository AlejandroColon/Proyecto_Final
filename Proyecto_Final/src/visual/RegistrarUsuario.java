...
public class RegistrarUsuario extends JDialog {
	...
	public RegistrarUsuario() {
		...
		maskName.setValidCharacters(
				"qwertyuiopasdfghjklzxcvbnñm" + "           QWERTYUIOPASDFGHJKLZXCVBNÑM " + "ÁáÉéÍíÚú");
							...
							if (Clinica.getInstance().findByCedula(txtCedula.getText()) == null) {
								...
								if (prueba.equals(pruebaconf)
									...
									JOptionPane.showMessageDialog(null,
											"Contraseñas no coinciden, favor volver a digitarlas", "Aviso",
											JOptionPane.WARNING_MESSAGE);
								} else {
									JOptionPane.showMessageDialog(null,
								...
								JOptionPane.showMessageDialog(null,
										"Cédula ingresada anteriormente; No puede haber usuarios duplicados", "Aviso",
